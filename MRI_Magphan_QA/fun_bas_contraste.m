function [contar] = fun_bas_contraste( I,centro_x,centro_y )

%I=dicomread('MAGPHAN.MR.QA_WEEKLY.0012.0087.2015.02.17.11.57.17.111091.91308349');
%h_im=imshow(I,[]);
...
line1x=[centro_x-26,centro_x];
line1y=[centro_y+31,centro_y];
