...
%%
%I=dicomread('MAGPHAN.MR.QA_WEEKLY.0010.0004.2015.02.17.11.57.17.111091.91302301');
%figure(1),h_im=imshow(I,[]);
%y=improfile;
%plot(y)
%min(y),max(y)
...
figura_corte=figure(1),imshow(I,[]);
print(figura_corte,'fig_corte','-dpng')
%movefile('fig_corte.png','/Users/MacBookPro/Documents/MATLAB/Guide/html/')
